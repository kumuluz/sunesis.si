...
import {Footer, CheckboxListComponent, References, SEO} from '../../components';
...
function CustomersPage() {
    const {t} = useI18next("customers");
    
    return (
        <Layout>
            <div className="customers">
                <SEO siteTitleId={["customers:site.title", "translations:site.title"]} canonical="/customers"/>
                    ...
                    <Row className="justify-content-center pt-3">
                        <Col xs="12" xl="9">
                            <h2 className="blue-400 mb-4">
                                {t("who-are.struggle.title")}
                            </h2>
                            <p className="mb-4">
                                {t("who-are.struggle.para")}
                            </p>
                ...
                <Container>
                    <Row className="justify-content-center pt-3">
                        <Col xs="12" xl="9">
                            <h2 className="blue-400 mb-4">
                                {t("who-are.help.title")}
                            </h2>
                            <p className="mb-4">
                                {t("who-are.help.para-1")}
                            </p>
                            <div className="header-image">
                                <img src={teamStockPhoto}/>
                            </div>
                            <p className="mb-4">
                                {t("who-are.help.para-2")}
                            </p>
                ...
                <Container>
                    <Row className="justify-content-center pt-3">
                        <Col xs="12" xl="9">
                            <h2 className="blue-400 mb-4">
                                {t("who-are.replatforming.title")}
                            </h2>
                            <p className="mb-4">
                                {t("who-are.replatforming.para-1")}
                            </p>
                            <div className="header-image">
                                <img src={planStockPhoto}/>
                            </div>
                            <p className="mb-4">
                                {t("who-are.replatforming.para-2")}
                            </p>
                ...
                <Container>
                    <Row className="justify-content-center pt-3">
                        <Col xs="12" xl="9">
                            <h2 className="blue-400 mb-4">
                                {t("who-are.striving.title")}
                            </h2>
                            <p className="mb-4">
                                {t("who-are.striving.para")}
                            </p>
