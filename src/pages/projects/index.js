            ...
            <div className="projects-page">
                ...
                <Container fluid={true} className="project-header">
                    <Row className="align-items-center flex-column">
                        <Col xs={12} className="justify-content-center d-flex">
                            <h2 className="text-center">
                                Projekt EDISON WINCI <br/>(ang. Eco Driving Innovative SOlutions and Networking -
                                Wireless Induction Charging Infrastructure)
                            </h2>
                        </Col>
                    </Row>
                    <Row className="justify-content-center mt-5">
                        <Col xs={12} md={10} lg={8}>
                            <p>
                                Projekt EDISON WINCI (ang. Eco Driving Innovative SOlutions and Networking - Wireless
                                Induction Charging Infrastructure) je bil uspešno izbran na Javnem razpisu za »<a
                            ...
                            <p>
                                ...
                                predvsem v večjih urbanih mestih, skoraj v celoti vir škodljivih emisij prašnih delcev
                                in NOx. Razvoj novih rešitev, kot je razvoj čistejših vozil, poleg spremembe obnašanja
                                uporabnikov zahteva tudi spremembo obnašanja ponudnikov novih čistejših rešitev oz.
                                poslovnih modelov, ki spremembo v prvi vrsti sploh omogočajo. Če želimo doseči tako
                                celovite preboje, pa so potrebni tudi celoviti pristopi in razvoj rešitev, ki bodo
                                uporabnikom omogočali enostaven prehod k novim tehnologijam ob večjem udobju in boljši
                            ...
                            <p>
                                ...
                                <ul>
                                    ...
                                    <li>bistveno daljše dosege električnih vozil (z več polnjenji na vmesnih
                                        postankih),
                                    </li>
                                    <li>enostavno polnjenje (v dinamični izvedbi brez nepotrebnih in neželenih
                                        postankov),
                                    </li>
                                    <li>zmanjšanje negativnega okoljskega vpliva proizvodnje in razgradnje baterij in
                                    </li>
                            ...
                            <p>
                                ...
                                tehnologijami (veriženje blokov, internet storitev/stvari, družbena omrežja,
                                računalniški oblak in pametni telefoni ...) omogoča razvoj novih inovativnih poslovnih
                                modelov multimodalne mobilnosti, ki podpirajo tudi razvoj delitvene ekonomije.
                            </p>
                            <p>
                                Zato želimo partnerji konzorcija v Sloveniji kot prvi razviti in v realnem okolju
                                validirati manjkajoče ključne gradnike celovitega podpornega okolja, ki bodo omogočali
                                enostavno brezkontaktno polnjenje električnih vozil in s tem podpirali razvoj
                                inovativnih poslovnih modelov delitvene ekonomije med uporabniki in ponudniki (energije,
                                infrastrukture, komponent, storitev, vozil idr.).
                            </p>
                            <p>
                                Glavni cilji in kazalniki projekta:<br/>
                                <strong>Cilj 1: Razvoj digitalnih rešitev</strong><br/>
                                Kazalnik: Aplikacija, s katero uporabnik (na mobilni napravi) enostavno in varno poišče,
                                rezervira, uporabi, vrne in plača storitev električne mobilnosti, ki temelji na sistemu
                                brezkontaktnega polnjenja EV (in povezuje storitve več kot enega ponudnika).
                                <br/><strong>Cilj 2: Razvoj gradnikov multimodalne mobilnosti</strong><br/>
                                Kazalnik: Razvit poslovni model za multimodalnost, ki vključuje EV z brezkontaktnim
                                polnjenjem (kot modul integriran v mobilno/spletno aplikacijo tretjih ponudnikov in
                                pospešuje uporabo EV z brezkontaktnim polnjenjem).
                                <br/><strong>Cilj 3: Prenos energije in povezava z energetskim sistemom</strong><br/>
                                Kazalnik: Razviti prototipi sestavnih elementov, s katerimi je omogočeno delovanje
                                statičnega indukcijskega polnjenja, z dokumentirani APIji. Vsaj 5 prototipov komponent
                                za opremljanje polnilnih postaj, z dokumentiranimi APIji.
                                <br/><strong>Cilj 4: Identifikacija in razvoj rešitev, primernih za integracijo v
                                vozila</strong><br/>
                                Kazalnik: Razvite komponente za povečanje učinkovitosti in varnosti električnih vozil.
                                Vsaj 5 prototipov komponent za povečanje učinkovitosti in varnosti električnih vozil.
                                <br/><strong>Cilj 5: Demonstracija delovanja sistema</strong><br/>
                                Kazalnik: Izvedena demonstracija delovanja celovite IT rešitve brezstičnega polnjenja
