        ...
        <Layout locale={i18n.language}>
            <div className="index-page">
                ...
                <div className="index-header">
                    <div className="index-header-content">
                        <div className="index-header-title">
                            <div className={i18n.language === "en" ? "localized-title-3" : "localized-title-1"}>
                                <h1>
                                    {t("index:header.titleStrong")}
                                </h1>
                            ...
                            <div className={i18n.language === "en" ? "localized-title-1" : "localized-title-3"}>
                                <h1 className="normal">
                        ...
                        <h2>
                            {t("index:header.subtitle-1")}
                            <br/>
                            {t("index:header.subtitle-2")}
                        </h2>
                        <div className="header-button"/>
                        <div className="emphasized-partners">
                            <div>
                                <h3 className="text-center">
                                    {t("index:header.they-trust-us")}
                                </h3>
                ...
                <div className="index-services-section">
                    <DarkFloatingSection
                        topContent={<ServicesSection locale={i18n.language} showCoreServices={true}/>}/>
